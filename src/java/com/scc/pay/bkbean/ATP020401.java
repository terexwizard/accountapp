...
@ManagedBean
@SessionScoped
public class ATP020401 extends BKBPage {
    ...
    private static final String PAGE_Q  = "atp020401q.xhtml";
...
//            toDB();
            ...
            IBusinessBase ib = BusinessFactory.getBusiness("ATP020401A");
            ...
            if(ib.isOk()){
                String msg = MessageUtil.getMessage("EP010");
                addErrorMessage(null,msg,msg);
            
                clearAllData();
                
                this.getMasterdata().setBfdate(CenterUtils.previousDayEn(Utils.getcurDateTime(),1));
            }
...
//            FacesContext.getCurrentInstance().renderResponse();
    ...
    private void update(){
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP020401U");
    ...
    public String delete(){
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP020401D");
...
//       
    ...
    public void selectSearchList(String para, Map<String, String> rec) {
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP020401S");
