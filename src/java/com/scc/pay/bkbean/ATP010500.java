...
@ManagedBean
@SessionScoped
public class ATP010500 extends BKBPage {

    
    private MainData masterdata ;
    private MainData searchparam;
    
    private static final String PAGE_E  = "atp010500e.xhtml";
    private static final String PAGE_Q  = "atp010500q.xhtml";
    ...
    public class MainData extends BBBase{
        ...
        public void setTbvat(TbVat tbvat) {
            this.tbvat = tbvat;
        }
...
//            toDB();
            ...
            IBusinessBase ib = BusinessFactory.getBusiness("ATP010500A");
...
//            FacesContext.getCurrentInstance().renderResponse();
    ...
    private void update(){
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP010500U");
    ...
    public String delete(){
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP010500D");
    ...
    private void search(){
            ...
            logger.debug("q para "+ this.getSearchparam().getTbvat().getVat()+", "+ 
                        this.getSearchparam().getTbvat().getDescription());
       
            HashMap<String, String> hm = new HashMap<String, String>();
            
            if(!Utils.NVL(this.getSearchparam().getTbvat().getVat()).equals("") && 
                    !Utils.NVL(this.getSearchparam().getTbvat().getVat()).equals("0")){
                hm.put("vat", Utils.NVL(this.getSearchparam().getTbvat().getVat()));
            }
            hm.put("description", Utils.NVL(this.getSearchparam().getTbvat().getDescription()));
    ...
    public void selectSearchList(String para, Map<String, String> rec) {
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP010500S");
