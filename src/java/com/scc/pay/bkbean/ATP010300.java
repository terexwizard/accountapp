...
import com.scc.pay.db.TbGroupPK;
...
public class ATP010300 extends BKBPage {
    ...
    public class MainData extends BBBase{
        private TbGroup tbgroup = null;

        public TbGroup getTbgroup() {
            if(tbgroup == null){
                tbgroup = new TbGroup(new TbGroupPK());
            }
            return tbgroup;
        }
...
//            FacesContext.getCurrentInstance().renderResponse();
    ...
    private void search(){
            ...
            hm.put("type", this.getSearchparam().getTbgroup().getTbGroupPK().getType());
            hm.put("data", this.getSearchparam().getTbgroup().getData());
