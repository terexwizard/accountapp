...
@ManagedBean
@SessionScoped
public class ATP010200 extends BKBPage {

    
    private MainData masterdata ;
    private MainData searchparam;
    
    private static final String PAGE_E  = "atp010200e.xhtml";
    private static final String PAGE_Q  = "atp010200q.xhtml";
...
//            toDB();
            ...
            IBusinessBase ib = BusinessFactory.getBusiness("ATP010200A");
...
//            FacesContext.getCurrentInstance().renderResponse();
    ...
    private void update(){
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP010200U");
    ...
    public String delete(){
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP010200D");
...
//       
            ...
            hm.put("currencyname", this.getSearchparam().getTbcurrency().getCurrencyname());
            hm.put("currencydesc", this.getSearchparam().getTbcurrency().getCurrencydesc());
    ...
    public void selectSearchList(String para, Map<String, String> rec) {
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP010200S");
