...
@ManagedBean
@SessionScoped
public class ATP010600 extends BKBPage {
    ...
    public class MainData extends BBBase{
        private TbWhtax tbwhtax;

        public TbWhtax getTbwhtax() {
            if(tbwhtax == null){
                tbwhtax = new TbWhtax();
            }
            return tbwhtax;
        ...
        public void setTbwhtax(TbWhtax tbwhtax) {
            this.tbwhtax = tbwhtax;
        }
...
//            FacesContext.getCurrentInstance().renderResponse();
    ...
    private void search(){
            ...
            logger.debug("q para "+ this.getSearchparam().getTbwhtax().getTax()+", "+ 
                        this.getSearchparam().getTbwhtax().getDescription());
       
            HashMap<String, String> hm = new HashMap<String, String>();
            
            if(!Utils.NVL(this.getSearchparam().getTbwhtax().getTax()).equals("") && 
                    !Utils.NVL(this.getSearchparam().getTbwhtax().getTax()).equals("0")){
                hm.put("tax", Utils.NVL(this.getSearchparam().getTbwhtax().getTax()));
            }
            hm.put("description", Utils.NVL(this.getSearchparam().getTbwhtax().getDescription()));
