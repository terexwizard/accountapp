...
@ManagedBean
@SessionScoped
public class ATP010400 extends BKBPage {

    
    private MainData masterdata ;
    private MainData searchparam;
    
    private static final String PAGE_E  = "atp010400e.xhtml";
    private static final String PAGE_Q  = "atp010400q.xhtml";
    ...
    public class MainData extends BBBase{
        private Invoicecompany invoicecompany = null;
...
//            toDB();
            ...
            IBusinessBase ib = BusinessFactory.getBusiness("ATP010400A");
...
//            FacesContext.getCurrentInstance().renderResponse();
    ...
    public String delete(){
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP010400D");
    ...
    private void search(){
            ...
            logger.debug("q para "+ this.getSearchparam().getInvoicecompany().getInvcomid()+", "+ 
                        this.getSearchparam().getInvoicecompany().getCompanyname());
    ...
    public void selectSearchList(String para, Map<String, String> rec) {
        ...
        IBusinessBase ib = BusinessFactory.getBusiness("ATP010400S");
