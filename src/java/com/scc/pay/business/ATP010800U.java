 ...
 * 12/06/2555 12:50:20
 */
public class ATP010800U extends BusinessImpl {
    ...
    protected Object doProcess(Object inobj) {
        ...
        logger.debug(">>ATP010800U " + frmi.getUserid());
        
        TbReceivedType recordn = frmi.getMasterdata().getTbreceivedtype();
        TbReceivedType record = em.find(TbReceivedType.class, recordn.getId());
      ...
      record.setRevalue(recordn.getRevalue());
      record.setRedesc(recordn.getRedesc());
